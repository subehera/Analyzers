// -*- C++ -*-
//
// Package:    Analyzers/DiHadronAnalyzer
// Class:      DiHadronAnalyzer
// 
/**\class DiHadronAnalyzer DiHadronAnalyzer.cc Analyzers/DiHadronAnalyzer/plugins/DiHadronAnalyzer.cc
...
//         Created:  Mon, 19 Jun 2017 11:22:42 GMT
//
//
...
// user include files
#include "Analyzers/DiHadronAnalyzer/interface/DiHadronAnalyzer.h"

//
// constructors and destructor
//
DiHadronAnalyzer::DiHadronAnalyzer(const edm::ParameterSet& iConfig)
  //tracks
...
DiHadronAnalyzer::~DiHadronAnalyzer()
{
...
void
DiHadronAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
DiHadronAnalyzer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
DiHadronAnalyzer::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
DiHadronAnalyzer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(DiHadronAnalyzer);
