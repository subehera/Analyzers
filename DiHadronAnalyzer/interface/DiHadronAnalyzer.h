...
// 
/**\class DiHadronAnalyzer DiHadronAnalyzer.h Analyzers/DiHadronAnalyzer/interface/DiHadronAnalyzer.h
...
class DiHadronAnalyzer : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit DiHadronAnalyzer(const edm::ParameterSet&);
      ~DiHadronAnalyzer();
