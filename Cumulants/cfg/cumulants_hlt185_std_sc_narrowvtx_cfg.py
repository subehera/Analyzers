...
#process.options.numberOfStreams = cms.untracked.uint32( 8 ) #same number as above
...
process.TFileService = cms.Service("TFileService",
     fileName = cms.string('cumulants_hlt185_std.root')
)
...
process.anaSC23 = process.stdAnalysisSC23narrowvtx.clone()
process.anaSC24 = process.stdAnalysisSC24narrowvtx.clone()
