...
process.TFileService = cms.Service("TFileService",
     fileName = cms.string('cumulants_hlt185_4sub.root')
)
...
process.anaSC23 = process.sub4AnalysisSC23narrowvtx.clone()
process.anaSC24 = process.sub4AnalysisSC24narrowvtx.clone()
