...
process.anaV2 = process.sub2gap2Analysis.clone()
process.anaV3 = process.sub2gap2V3Analysis.clone()
process.anaV4 = process.sub2gap2V4Analysis.clone()
process.anaSC23 = process.sub2gap2AnalysisSC23.clone()
process.anaSC24 = process.sub2gap2AnalysisSC24.clone()
