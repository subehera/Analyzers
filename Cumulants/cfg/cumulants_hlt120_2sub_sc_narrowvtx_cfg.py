...
process.TFileService = cms.Service("TFileService",
     fileName = cms.string('cumulants_hlt120_2sub.root')
)
...
process.anaSC23 = process.sub2AnalysisSC23narrowvtx.clone()
process.anaSC24 = process.sub2AnalysisSC24narrowvtx.clone()
