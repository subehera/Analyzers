...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        'root://cms-xrd-global.cern.ch///store/data/Run2015E/HighMultiplicity/AOD/PromptReco-v1/000/262/157/00000/B202E04B-9291-E511-B2CE-02163E014151.root'
    )
)
...
process.defaultTrigSel = hlt110.clone()
