...
process.TFileService = cms.Service("TFileService",
     fileName = cms.string('cumulants_hlt150_3sub.root')
)
...
process.anaSC23 = process.sub3AnalysisSC23narrowvtx.clone()
process.anaSC24 = process.sub3AnalysisSC24narrowvtx.clone()
