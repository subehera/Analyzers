...
defaultAnalysis_Pt10POS = defaultCumu.clone()
defaultAnalysis_Pt10POS.ptsubmin = cms.vdouble(0.3,0.3,0.3,0.3,0.3,0.3,0.3,10.0)
defaultAnalysis_Pt10POS.ptsubmax = cms.vdouble(3.0,3.0,3.0,3.0,3.0,3.0,3.0,10000.0)

defaultAnalysis_Pt10NEG = defaultCumu.clone()
defaultAnalysis_Pt10NEG.ptsubmin = cms.vdouble(0.3,0.3,0.3,10.0,0.3,0.3,0.3,0.3)
defaultAnalysis_Pt10NEG.ptsubmax = cms.vdouble(3.0,3.0,3.0,10000.0,3.0,3.0,3.0,3.0)
...
### symmetric cumulants
# default 2-subevent
defaultAnalysisSC23 = defaultCumu.clone()
defaultAnalysisSC23.harm = cms.untracked.vint32(2,3,2,3)

defaultAnalysisSC24 = defaultCumu.clone()
defaultAnalysisSC24.harm = cms.untracked.vint32(2,4,2,4)
