...
#    config.Site.storageSite = 'T3_US_Rice'
    ...
    config.General.requestName = 'JulyLowPU_pp13TeV_cumulants_4sub_mb1_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_JulyLowPU_cumulants_4sub_mb1_sc_v1'
    submit(config)

    config.General.requestName = 'JulyLowPU_pp13TeV_cumulants_4sub_mb2_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_JulyLowPU_cumulants_4sub_mb2_sc_v1'
    submit(config)

    config.General.requestName = 'JulyLowPU_pp13TeV_cumulants_4sub_mb3_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_JulyLowPU_cumulants_4sub_mb3_sc_v1'
    submit(config)

    config.General.requestName = 'JulyLowPU_pp13TeV_cumulants_4sub_mb4_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_JulyLowPU_cumulants_4sub_mb4_sc_v1'
    submit(config)

    config.General.requestName = 'JulyLowPU_pp13TeV_cumulants_4sub_mb5_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_JulyLowPU_cumulants_4sub_mb5_sc_v1'
    submit(config)

    config.General.requestName = 'JulyLowPU_pp13TeV_cumulants_4sub_mb6_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_JulyLowPU_cumulants_4sub_mb6_sc_v1'
    submit(config)

    config.General.requestName = 'JulyLowPU_pp13TeV_cumulants_4sub_mb7_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_JulyLowPU_cumulants_4sub_mb7_sc_v1'
    submit(config)

    config.General.requestName = 'JulyLowPU_pp13TeV_cumulants_4sub_mb8_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_JulyLowPU_cumulants_4sub_mb8_sc_v1'
    submit(config)

    config.General.requestName = 'VdM2015_pp13TeV_cumulants_4sub_mb1_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_VdM2015_cumulants_4sub_mb1_sc_v1'
    submit(config)

    config.General.requestName = 'VdM2015_pp13TeV_cumulants_4sub_mb2_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_VdM2015_cumulants_4sub_mb2_sc_v1'
    submit(config)

    config.General.requestName = 'VdM2015_pp13TeV_cumulants_4sub_mb3_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_VdM2015_cumulants_4sub_mb3_sc_v1'
    submit(config)

    config.General.requestName = 'VdM2015_pp13TeV_cumulants_4sub_mb4_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_VdM2015_cumulants_4sub_mb4_sc_v1'
    submit(config)

    config.General.requestName = 'VdM2015_pp13TeV_cumulants_4sub_mb5_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_VdM2015_cumulants_4sub_mb5_sc_v1'
    submit(config)

    config.General.requestName = 'VdM2015_pp13TeV_cumulants_4sub_mb6_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_VdM2015_cumulants_4sub_mb6_sc_v1'
    submit(config)

    config.General.requestName = 'VdM2015_pp13TeV_cumulants_4sub_mb7_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_VdM2015_cumulants_4sub_mb7_sc_v1'
    submit(config)

    config.General.requestName = 'VdM2015_pp13TeV_cumulants_4sub_mb8_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_VdM2015_cumulants_4sub_mb8_sc_v1'
    submit(config)

    config.General.requestName = 'TOTEM_pp13TeV_cumulants_4sub_mb1_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_TOTEM_cumulants_4sub_mb1_sc_v1'
    submit(config)

    config.General.requestName = 'TOTEM_pp13TeV_cumulants_4sub_mb2_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_TOTEM_cumulants_4sub_mb2_sc_v1'
    submit(config)

    config.General.requestName = 'TOTEM_pp13TeV_cumulants_4sub_mb3_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_TOTEM_cumulants_4sub_mb3_sc_v1'
    submit(config)

    config.General.requestName = 'TOTEM_pp13TeV_cumulants_4sub_mb4_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_TOTEM_cumulants_4sub_mb4_sc_v1'
    submit(config)

    config.General.requestName = 'TOTEM_pp13TeV_cumulants_4sub_mb5_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_TOTEM_cumulants_4sub_mb5_sc_v1'
    submit(config)

    config.General.requestName = 'TOTEM_pp13TeV_cumulants_4sub_mb6_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_TOTEM_cumulants_4sub_mb6_sc_v1'
    submit(config)

    config.General.requestName = 'TOTEM_pp13TeV_cumulants_4sub_mb7_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_TOTEM_cumulants_4sub_mb7_sc_v1'
    submit(config)

    config.General.requestName = 'TOTEM_pp13TeV_cumulants_4sub_mb8_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_TOTEM_cumulants_4sub_mb8_sc_v1'
    submit(config)

    config.General.requestName = 'MD2_pp13TeV_cumulants_4sub_mb1_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_MD2_cumulants_4sub_mb1_sc_v1'
    submit(config)

    config.General.requestName = 'MD2_pp13TeV_cumulants_4sub_mb2_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_MD2_cumulants_4sub_mb2_sc_v1'
    submit(config)

    config.General.requestName = 'MD2_pp13TeV_cumulants_4sub_mb3_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_MD2_cumulants_4sub_mb3_sc_v1'
    submit(config)

    config.General.requestName = 'MD2_pp13TeV_cumulants_4sub_mb4_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_MD2_cumulants_4sub_mb4_sc_v1'
    submit(config)

    config.General.requestName = 'MD2_pp13TeV_cumulants_4sub_mb5_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_MD2_cumulants_4sub_mb5_sc_v1'
    submit(config)

    config.General.requestName = 'MD2_pp13TeV_cumulants_4sub_mb6_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_MD2_cumulants_4sub_mb6_sc_v1'
    submit(config)

    config.General.requestName = 'MD2_pp13TeV_cumulants_4sub_mb7_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_MD2_cumulants_4sub_mb7_sc_v1'
    submit(config)

    config.General.requestName = 'MD2_pp13TeV_cumulants_4sub_mb8_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_MD2_cumulants_4sub_mb8_sc_v1'
    submit(config)

    config.General.requestName = 'MD2_pp13TeV_cumulants_4sub_mb9_sc_v1'
    ...
    config.Data.outputDatasetTag = 'pp13TeV_MD2_cumulants_4sub_mb9_sc_v1'
    submit(config)

    config.General.requestName = 'MD34_pp13TeV_cumulants_4sub_mb1_sc_v1'
    config.Data.inputDataset = '/L1MinimumBias1/davidlw-RecoSkim2016_2016H_MD34_MB1_v1-e83d32f7a8d5ff64616c674d8395d834/USER'
    config.Data.outputDatasetTag = 'pp13TeV_MD34_cumulants_4sub_mb1_sc_v1'
    submit(config)

    config.General.requestName = 'MD34_pp13TeV_cumulants_4sub_mb2_sc_v1'
    config.Data.inputDataset = '/L1MinimumBias2/davidlw-RecoSkim2016_2016H_MD34_MB2_v1-e83d32f7a8d5ff64616c674d8395d834/USER'
    config.Data.outputDatasetTag = 'pp13TeV_MD34_cumulants_4sub_mb2_sc_v1'
    submit(config)

    config.General.requestName = 'MD34_pp13TeV_cumulants_4sub_mb3_sc_v1'
    config.Data.inputDataset = '/L1MinimumBias3/davidlw-RecoSkim2016_2016H_MD34_MB3_v1-e83d32f7a8d5ff64616c674d8395d834/USER'
    config.Data.outputDatasetTag = 'pp13TeV_MD34_cumulants_4sub_mb3_sc_v1'
    submit(config)

    config.General.requestName = 'MD34_pp13TeV_cumulants_4sub_mb4_sc_v1'
    config.Data.inputDataset = '/L1MinimumBias4/davidlw-RecoSkim2016_2016H_MD34_MB4_v1-e83d32f7a8d5ff64616c674d8395d834/USER'
    config.Data.outputDatasetTag = 'pp13TeV_MD34_cumulants_4sub_mb4_sc_v1'
    submit(config)

    config.General.requestName = 'MD34_pp13TeV_cumulants_4sub_mb5_sc_v1'
    config.Data.inputDataset = '/L1MinimumBias5/davidlw-RecoSkim2016_2016H_MD34_MB5_v1-e83d32f7a8d5ff64616c674d8395d834/USER'
    config.Data.outputDatasetTag = 'pp13TeV_MD34_cumulants_4sub_mb5_sc_v1'
    submit(config)

    config.General.requestName = 'MD34_pp13TeV_cumulants_4sub_mb6_sc_v1'
    config.Data.inputDataset = '/L1MinimumBias6/davidlw-RecoSkim2016_2016H_MD34_MB6_v1-e83d32f7a8d5ff64616c674d8395d834/USER'
    config.Data.outputDatasetTag = 'pp13TeV_MD34_cumulants_4sub_mb6_sc_v1'
    submit(config)

    config.General.requestName = 'MD34_pp13TeV_cumulants_4sub_mb7_sc_v1'
    config.Data.inputDataset = '/L1MinimumBias7/davidlw-RecoSkim2016_2016H_MD34_MB7_v1-e83d32f7a8d5ff64616c674d8395d834/USER'
    config.Data.outputDatasetTag = 'pp13TeV_MD34_cumulants_4sub_mb7_sc_v1'
    submit(config)

    config.General.requestName = 'MD34_pp13TeV_cumulants_4sub_mb8_sc_v1'
    config.Data.inputDataset = '/L1MinimumBias8/davidlw-RecoSkim2016_2016H_MD34_MB8_v1-e83d32f7a8d5ff64616c674d8395d834/USER'
    config.Data.outputDatasetTag = 'pp13TeV_MD34_cumulants_4sub_mb8_sc_v1'
    submit(config)

    config.General.requestName = 'MD34_pp13TeV_cumulants_4sub_mb9_sc_v1'
    config.Data.inputDataset = '/L1MinimumBias9/davidlw-RecoSkim2016_2016H_MD34_MB9_v1-e83d32f7a8d5ff64616c674d8395d834/USER'
    config.Data.outputDatasetTag = 'pp13TeV_MD34_cumulants_4sub_mb9_sc_v1'
    submit(config)
