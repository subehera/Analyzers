...
#    config.Site.storageSite = 'T3_US_Rice'
    ...
    config.Data.lumiMask = 'Cert_285479-285832_HI8TeV_PromptReco_pPb_Collisions16_JSON_NoL1T.txt'
    config.Data.outputDatasetTag = 'RecoSkim2016_pPb250_cumulants_std_v10'
    config.JobType.psetName = '../cfg/cumulants_hlt250_std_cfg.py'
    submit(config)

    config.General.requestName = 'pPb2016_Pbp250_cumulants_std_b7_v10'
    config.Data.lumiMask = 'Cert_285952-286496_HI8TeV_PromptReco_Pbp_Collisions16_JSON_NoL1T.txt'
