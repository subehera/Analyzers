if __name__ == '__main__':
    ...
    config.General.requestName = 'PbPbppRereco2015_cumulants_std_b5_c2_v1'
    config.Data.inputDataset = '/HIMinimumBias5/HIRun2015-02May2016-v1/AOD'
    submit(config)

    config.General.requestName = 'PbPbppRereco2015_cumulants_std_b6_c2_v1'
    config.Data.inputDataset = '/HIMinimumBias6/HIRun2015-02May2016-v1/AOD'
    submit(config)

    config.General.requestName = 'PbPbppRereco2015_cumulants_std_b7_c2_v1'
    config.Data.inputDataset = '/HIMinimumBias7/HIRun2015-02May2016-v1/AOD'
    submit(config)

    config.General.requestName = 'PbPbppRereco2015_TrkOnly_cumulants_std_b5_c2_v1'
    config.Data.lumiMask = 'Cert_263685-263757_PromptReco_HICollisions15_TrackerOnly_JSON.txt'
    config.Data.inputDataset = '/HIMinimumBias5/HIRun2015-02May2016-v1/AOD'
    submit(config)

    config.General.requestName = 'PbPbppRereco2015_TrkOnly_cumulants_std_b6_c2_v1'
    config.Data.inputDataset = '/HIMinimumBias6/HIRun2015-02May2016-v1/AOD'
    submit(config)

    config.General.requestName = 'PbPbppRereco2015_TrkOnly_cumulants_std_b7_c2_v1'
    config.Data.inputDataset = '/HIMinimumBias7/HIRun2015-02May2016-v1/AOD'
    submit(config)
