if __name__ == '__main__':
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b1_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b2_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b3_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b4_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b5_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b6_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b7_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b8_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b9_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b10_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b11_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b12_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b13_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b14_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b15_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b16_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b17_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b18_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b19_sc_v1'
    submit(config)
    ...
    config.Data.outputDatasetTag = 'pp2015E_cumulants_4sub_b20_sc_v1'
    submit(config)
