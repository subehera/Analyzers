...
if [ ${subevt} -eq 1 ] 
then
  macro/PlotVnm --input "/eos/cms/store/group/phys_heavyions/flowcorr/SubCumu/PAMinimumBias*/*_std_sc_v11/*/*/*sc*.root" --noffmin ${multmin} --noffmax ${multmax} --subevt ${subevt} --output ${fname} --harmonicorder0 ${harm0} --harmonicorder1 ${harm1} --folder ${folder} --cumumaxorder 4 --process
elif [ ${subevt} -eq 2 ]
then
  macro/PlotVnm --input "/eos/cms/store/group/phys_heavyions/flowcorr/SubCumu/PAMinimumBias*/*_${subevt}sub_sc_v11/*/*/*sc*.root" --noffmin ${multmin} --noffmax ${multmax} --subevt ${subevt} --output ${fname} --harmonicorder0 ${harm0} --harmonicorder1 ${harm1} --folder ${folder} --cumumaxorder 4 --process
elif [ ${subevt} -eq 3 ]
then
  macro/PlotVnm --input "/eos/cms/store/group/phys_heavyions/flowcorr/SubCumu/PAMinimumBias*/*_${subevt}sub_sc_v11/*/*/*sc*.root" --noffmin ${multmin} --noffmax ${multmax} --subevt ${subevt} --output ${fname} --harmonicorder0 ${harm0} --harmonicorder1 ${harm1} --folder ${folder} --cumumaxorder 4 --process
elif [ ${subevt} -eq 4 ]
