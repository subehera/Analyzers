...
{
   TFile* f[100];
   f[0] = new TFile(Form("cnm_vnm_std_V%d.root",n));
   f[1] = new TFile(Form("cnm_vnm_2sub_V%d.root",n));
   f[2] = new TFile(Form("cnm_vnm_3sub_V%d.root",n));
   f[3] = new TFile(Form("cnm_vnm_4sub_V%d.root",n));
   ...
   h24[0] = (TH1D*)f[0]->Get(Form("hC%d%d4_51_rebinned",n,n));
   h26[0] = (TH1D*)f[0]->Get(Form("hC%d%d6_119_rebinned",n,n));
   h28[0] = (TH1D*)f[0]->Get(Form("hC%d%d8_rebinned",n,n));

   h24[1] = (TH1D*)f[1]->Get(Form("hC%d%d4_51_rebinned",n,n));
   h26[1] = (TH1D*)f[1]->Get(Form("hC%d%d6_119_rebinned",n,n));
   h28[1] = (TH1D*)f[1]->Get(Form("hC%d%d8_rebinned",n,n));

   h24[2] = (TH1D*)f[2]->Get(Form("hC%d%d4_51_rebinned",n,n));
   h26[2] = (TH1D*)f[2]->Get(Form("hC%d%d6_119_rebinned",n,n));
   h28[2] = (TH1D*)f[2]->Get(Form("hC%d%d8_rebinned",n,n));

   h24[3] = (TH1D*)f[3]->Get(Form("hC%d%d4_51_rebinned",n,n));
   h26[3] = (TH1D*)f[3]->Get(Form("hC%d%d6_119_rebinned",n,n));
   h28[3] = (TH1D*)f[3]->Get(Form("hC%d%d8_rebinned",n,n));
